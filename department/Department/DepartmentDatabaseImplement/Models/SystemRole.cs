...
{
    [DataContract]
    public class SystemRole : ISystemRoleModel
    {
        [DataMember]
        ...
        public static SystemRole? Create(SystemRoleBindingModel model)
        {
        ...
        public void Update(SystemRoleBindingModel model)
        {
        ...
        public SystemRoleViewModel GetViewModel => new()
        {
            Id = Id,
            Code = Code,
            Name = Name
